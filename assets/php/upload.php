...
class RealAjaxUploader
{
	...
	function __construct($deny_ext=array())
	{
		...
		// $this->setUploadPath("../../image/".$this->_EMP_NO);
		...
		$file_data 	= pathinfo($_REQUEST['ax-file-name']);
		$this->file_name = $this->_EMP_NO.".".$file_data['extension'];
	...
	public function setUploadPath($upload_path)
	{
		...
		// $upload_path = "../../image/".$this->_EMP_NO;
